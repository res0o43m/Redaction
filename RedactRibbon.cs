...
{
    [ComVisible(true)]
    public partial class Ribbon2 : Office.IRibbonExtensibility, IRedactRibbon
    {
        ...
        public System.Drawing.Bitmap RibbonLoadImages(string image)
        {
        ...
        private static string GetResourceText(string resourceName)
        {
            ...
            Debug.WriteLine("XML Name: " + resourceName);
